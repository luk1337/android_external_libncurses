...
(*.[0-9]*)
	...
	if test ! -f /mnt/ssd-2/lineage-18.0/external/libncurses/man_alias.sed ; then
cat >>/mnt/ssd-2/lineage-18.0/external/libncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /mnt/ssd-2/lineage-18.0/external/libncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /mnt/ssd-2/lineage-18.0/external/libncurses/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /mnt/ssd-2/lineage-18.0/external/libncurses/man_alias.sed \
		< $i >$TMP
